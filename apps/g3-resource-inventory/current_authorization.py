...
from inventory import CurrentAuthorizationEvidence, READ_ACTION


class BoundResourceAuthorization:
    def __init__(
        self,
        *,
        principal: Principal,
    ...
    def require(
        ...
        *,
        ...
        if action != READ_ACTION:
            raise AdmissionDenied("action is outside the bounded G3 authorization surface")
        ...
        evidence = captured[0]
        if evidence.tenant_id != tenant_id or evidence.action != READ_ACTION:
