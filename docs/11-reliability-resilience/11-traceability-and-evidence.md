...
| ADR-015 | Secrets and key-management authority, including rotation, revocation, lease and crypto-erasure continuity. | `02`, `06`, `07`, `09`, `13` | `FV-SECRET-001` and cryptographic variants of recovery vectors. |
...
| ADR-018 | Backup, restore and disaster-recovery authority, reconciliation interval `(R,F]`, and non-authoritative restored state. | `06`, `07`, `09`, `11`, `13` | `FV-REC-001` through `FV-REC-003`. |
