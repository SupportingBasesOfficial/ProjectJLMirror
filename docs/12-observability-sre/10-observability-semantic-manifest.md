...
Every Product-gated row whose closed selector admits `product_state_unproven` SHALL include `OBSV-037` in `required_fault_vectors`; narrative inheritance from the validation matrix is insufficient.
