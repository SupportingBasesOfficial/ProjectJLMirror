...
The corrected harness executes an exact validator-pinned set of **107** positive and negative probes covering:
...
- direct, positional, and nested textual JSON serialization rejection, URL/form serialization rejection after percent-decoding, standalone fully percent-escaped serialization rejection, plus rejection of opaque text fragments containing known secret-authority handles;
