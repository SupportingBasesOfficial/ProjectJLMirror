...
_SCOPE_CORE_PATH = ROOT / "implementation/g2-monitoring-source-onboarding-authorization/g2_scope_core.py"
...
AUTH_PR_ALLOWED_PATHS = {
    ...
    "implementation/g2-monitoring-source-onboarding-authorization/g2_scope_core.py",
    "implementation/g2-monitoring-source-onboarding-authorization/g2_authorization_core.py",
...
def validate_scope_workflow_text(text: str) -> list[str]:
    # The privileged issue_comment publisher is canonical-content locked.
    # This proves the complete ordered job/step/script surface, not selected markers.
