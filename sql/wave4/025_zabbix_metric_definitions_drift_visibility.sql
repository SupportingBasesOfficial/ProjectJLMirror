-- Wave 4 metric-definition drift visibility hardening.
-- A value-kind drift is visible on exactly the affected accepted definition/binding,
-- while unrelated metadata from the rejected snapshot remains unapplied.
