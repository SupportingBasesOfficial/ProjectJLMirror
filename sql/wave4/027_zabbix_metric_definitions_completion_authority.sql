-- Wave 4 metric-definition completion authority hardening.
-- Completion revalidates current source/generation/config/scope/admission authority while
-- holding the source row lock. Existing item bindings cannot silently move between hosts.
