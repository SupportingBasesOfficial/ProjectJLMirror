...
class CreateMonitoringSourceCommand:
    ...
    def __post_init__(self) -> None:
        ...
        _canonical_explicit_text(self.provider_instance_ref, "provider_instance_ref", max_len=512)
...
@dataclass(frozen=True)
class MonitoringSourceGeneration:
    tenant_id: str
    monitoring_source_id: str
...
class SourceCreationPlan:
    ...
    generation: MonitoringSourceGeneration
...
def plan_source_creation(
    ...
    *,
    ...
    scope_tenant_binding_id_factory: Callable[[], str] = lambda: opaque_token("mon-bind"),
    ...
    scope_tenant_binding_id = scope_tenant_binding_id_factory()
    ...
    generated = (
        ...
        ("provider_scope_tenant_binding_id", scope_tenant_binding_id),
    ...
    generation_record = MonitoringSourceGeneration(
        tenant_id=command.tenant_id,
        monitoring_source_id=source_id,
        source_instance_generation=generation,
        provider_profile="zabbix",
        provider_instance_ref=command.provider_instance_ref,
