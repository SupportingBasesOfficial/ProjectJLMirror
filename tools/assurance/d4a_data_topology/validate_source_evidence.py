...
def main() -> int:
    ...
    print(
        ...
        f"global_promoted_credit={len(promoted)} historical_gate=scoped historical_kafka_selection=not_selected current_gate=separately_accepted current_kafka_selection=selected "
