...
def main(argv: list[str]) -> int:
    ...
    if errors:
        ...
        return 1
    print("d4b_contract_version_source=PASS historical_oracle=preserved current_d4b=5_of_5_selected current_d4c=9_of_9_selected current_d4d=5_of_5 d4wide=26_of_26")
    return 0
