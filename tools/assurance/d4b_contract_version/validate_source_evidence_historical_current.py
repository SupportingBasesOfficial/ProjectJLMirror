...
EXPECTED_ASSERTIONS = {
    ...
    "opaque_fixture_mapping_is_collision_free_over_the_bounded_uint64_test_domain_via_bijective_permutation",
...
def main(argv: list[str]) -> int:
    ...
    if errors:
        ...
        return 1
    print("d4b_contract_version_source_manifest=PASS axis=OPEN-EVT-004 concrete_candidates=3 eligible=3 opaque_monotonic_issuance=required opaque_fixture_uniqueness=bijective historical_family_continuity=required equivalent=insufficient_evidence selection=not_selected syntax_selected=false ledger_credit=0 d4=scoped authorities=not_granted")
    return 0
