...
def main() -> int:
    ...
    assert sum(len(track["evidence_completed"]) for track in state_tracks) == 23
    ...
    print("d4b_schema_contract_source_manifest=PASS evidence_ids=5 source_history=not_selected current_selection=selected_c2_profile d4a=7_of_7 d4c=9_of_9 d4d=2_of_5 d4wide=23/26 authorities=not_granted")
    return 0
