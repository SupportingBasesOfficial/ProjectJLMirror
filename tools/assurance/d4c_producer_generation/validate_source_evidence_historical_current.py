...
def main() -> int:
    ...
    if plan.get("ledger_credit_state") != "nine_of_nine":
        return fail("D4-C current ledger must be nine_of_nine after separate promotions")
    ...
    if sum(len(track.get("evidence_completed", [])) for track in tracks.values()) != 21:
        return fail("D4-wide current credit count must be 21/26")
    ...
    print(
        ...
        "source_history=non_promoting_at_5_of_9 current_d4c=9/9 d4wide=21/26 "
