...
def main():
 ...
 print('d4_state_falsification=PASS total_required=26 total_credited=26 all_d4d_credit_regressions=blocked duplicate=blocked selection=blocked authorities=blocked separate_acceptance=preserved')
 return 0
