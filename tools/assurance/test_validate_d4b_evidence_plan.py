...
def main() -> int:
    ...
    must_fail(lambda d: track(d, "D4-A")["evidence_completed"].pop(), "D4-A selected 7/7 state drift")
    ...
    print(
        ...
        "promotion_record_authority=blocked provenance_tamper=blocked source_mutation=blocked d4a_regression=blocked "
