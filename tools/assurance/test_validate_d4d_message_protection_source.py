...
def main():
    ...
    def grant_fourth(r):
        def fn(d):
            t=d['tracks'][3]; fourth=v.REQUIRED[3]; t['evidence_remaining'].remove(fourth); t['evidence_completed'].append(fourth)
    ...
    print('d4d_message_protection_source_falsification=PASS fourth_credit_without_promotion=blocked source_snapshot=preserved authority_leakage=blocked')
