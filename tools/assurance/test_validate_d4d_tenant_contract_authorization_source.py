...
def main():
 ...
 def grant_third(r):
  def fn(d):
   t=d['tracks'][3]; third=v.REQUIRED[2]; t['evidence_remaining'].remove(third); t['evidence_completed'].append(third)
 ...
 print('d4d_tenant_contract_authorization_source_falsification=PASS third_credit_without_promotion=blocked source_snapshot=preserved')
