...
def main():
    ...
    print('d4d_trace_context_source_falsification=PASS source_snapshot=4_of_5_25_of_26_preserved auto_credit=blocked fifth_credit_without_promotion=blocked selection=blocked authority_leakage=blocked')
