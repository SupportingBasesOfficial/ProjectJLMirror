...
POLICY = {
    ...
    "trusted_evaluator_event": "pull_request_target",
    "trusted_evaluator_source": "pull_request_exact_base_commit",
}
...
def falsify_real_git_diff_gate() -> None:
    ...
    try:
        ...
        relevant, errors = scope.validate(
            base,
            head,
...
def main() -> int:
    ...
    print("g1_implementation_scope_falsification=PASS shared_core=blocked mixed_diff=blocked real_git_diff=executed metadata=label+branch+claim_fail_closed policy_self_declaration=blocked allowed_paths=accepted")
    return 0
