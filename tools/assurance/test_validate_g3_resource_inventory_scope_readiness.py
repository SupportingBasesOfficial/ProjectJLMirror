...
import copy
import validate_g3_resource_inventory_scope_readiness as validator

REPO = "SupportingBasesOfficial/ProjectJLMirror"
SERVER = "https://github.com"
BASE = "a" * 40
HEAD = "b" * 40
HEAD_REF = "impl/g3-resource-inventory-demo"
PR_NUMBER = 3003
RUN_ID = 434343
...
def main() -> int:
    ...
    reject(lambda a: a[1]["head"].update(ref="feature/not-g3"), "canonical G3 prefix")
    ...
    print("g3_scope_readiness_falsification=PASS live_coordinates=bound creator=bound workflow=bound publisher_job=bound")
    return 0
