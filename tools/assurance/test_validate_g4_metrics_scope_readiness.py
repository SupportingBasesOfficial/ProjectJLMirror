...
import copy
import validate_g4_metrics_scope_readiness as validator

REPO = "SupportingBasesOfficial/ProjectJLMirror"
SERVER = "https://github.com"
BASE = "a" * 40
HEAD = "b" * 40
HEAD_REF = "impl/g4-metrics-demo"
PR_NUMBER = 3003
RUN_ID = 434343
...
def main() -> int:
    ...
    reject(lambda a: a[1]["head"].update(ref="feature/not-g4"), "canonical G4 prefix")
    ...
    print("g4_scope_readiness_falsification=PASS live_coordinates=bound creator=bound workflow=bound publisher_job=bound")
    return 0
