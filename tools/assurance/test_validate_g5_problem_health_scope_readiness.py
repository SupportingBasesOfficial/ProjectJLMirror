...
BASE = "a" * 40
HEAD = "b" * 40
HEAD_REF = "impl/g5-problem-health-demo"
PR_NUMBER = 3003
RUN_ID = 434343
...
def main() -> int:
    ...
    reject(lambda a: a[1]["head"].update(ref="feature/not-g4"), "canonical G5 prefix")
    ...
    print("g5_scope_readiness_falsification=PASS live_coordinates=bound creator=bound workflow=bound publisher_job=bound")
    return 0
