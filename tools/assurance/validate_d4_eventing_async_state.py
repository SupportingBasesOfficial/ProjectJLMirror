...
EXPECTED_COMPLETED={'D4-A':list(EXPECTED_REQUIRED_EVIDENCE['D4-A']),'D4-B':list(EXPECTED_REQUIRED_EVIDENCE['D4-B']),'D4-C':list(EXPECTED_REQUIRED_EVIDENCE['D4-C']),'D4-D':EXPECTED_REQUIRED_EVIDENCE['D4-D'][:4]}
...
if __name__=='__main__':
 ...
 print('d4_eventing_async_state=PASS evidence_required=26 evidence_credited=25 d4a=7_of_7 d4b=5_of_5 d4c=9_of_9 d4d=4_of_5 selection_open authorities=unchanged')
