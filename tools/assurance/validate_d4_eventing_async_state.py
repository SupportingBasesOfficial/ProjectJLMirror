...
if __name__=='__main__':
 ...
 print('d4_eventing_async_state=PASS evidence_required=26 evidence_credited=26 d4a=7_of_7 d4b=5_of_5 d4c=9_of_9 d4d=5_of_5 selection_open authorities=unchanged')
