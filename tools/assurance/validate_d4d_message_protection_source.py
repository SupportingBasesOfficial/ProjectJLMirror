...
FIRST='workload_identity_to_broker_credential_adapter_least_privilege'; SECOND='tenant_and_contract_scoped_producer_consumer_authorization'; EXPECTED_ID='message_protection_key_authority_and_historical_verifier_continuity'; FOURTH='secret_credential_payload_exclusion_and_erasure_boundary'; FIFTH='trace_context_observability_only_validation_and_redaction'; EXPECTED_DECISION='OPEN-EVT-017'; EXPECTED_AXIS=EXPECTED_ID
...
if __name__=='__main__':
    ...
    print('d4d_message_protection_source=PASS source_snapshot=2_of_5 historical_gate=scoped source_auto_credit=false current_gate=separately_accepted current_d4d=5_of_5_selected d4wide=26/26 authorities=unchanged probes=17')
