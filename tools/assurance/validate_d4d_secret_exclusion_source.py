...
'text_serialized_resolved_secret_material_rejected','positional_text_serialized_resolved_secret_material_rejected','nested_text_serialized_resolved_secret_material_rejected','url_form_serialized_resolved_secret_material_rejected','url_escaped_serialized_resolved_secret_material_rejected','double_url_escaped_serialized_resolved_secret_material_rejected','secret_handle_text_fragment_rejected',
...
if __name__=='__main__':
    ...
    print('d4d_secret_exclusion_source=PASS source_snapshot=3_of_5 source_auto_credit=false current_d4d=3_of_5 d4wide=24/26 selection=not_selected authorities=unchanged probes=108 corrected_lineage=true')
