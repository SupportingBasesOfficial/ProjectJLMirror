...
if __name__=='__main__':
 ...
 print('d4d_tenant_contract_authorization_source=PASS source_snapshot=1_of_5 source_auto_credit=false current_d4d=5_of_5 d4wide=26/26 selection=not_selected authorities=unchanged')
