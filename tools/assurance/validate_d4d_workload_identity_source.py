...
REQUIRED=[EXPECTED_ID,SECOND,THIRD,FOURTH,'trace_context_observability_only_validation_and_redaction']; CURRENT_CREDITS=REQUIRED[:4]
def validate(root):
 ...
 if d.get('required_evidence')!=REQUIRED or d.get('evidence_completed')!=CURRENT_CREDITS or d.get('evidence_remaining')!=REQUIRED[4:]:e.append('current D4-D state must reflect exactly four separate promotions')
...
if __name__=='__main__':
 ...
 print('d4d_workload_identity_source=PASS source_snapshot=0_of_5 current_d4d=4_of_5 d4wide=25/26 selection=not_selected authorities=unchanged')
