...
def main() -> None:
    ...
    for marker in (
        ...
        "`health_transition_id` MUST reference that exact immutable Monitoring transition record",
        "pure re-confirmation, evidence refresh, stale/incomplete marking, metadata refresh or projection update",
