...
def main() -> None:
    ...
    require("initial_validation_stale_authority" in sql, "stale authority fence missing")
    ...
    print("wave4_zabbix_initial_validation_worker=PASS hostgroup_only=true credential=port egress=port stale_commit=fenced retry=not_selected ingestion=none")
