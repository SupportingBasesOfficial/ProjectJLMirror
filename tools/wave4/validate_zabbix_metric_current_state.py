...
def main() -> None:
    ...
    for marker in (
        ...
        "monitoring_metric_current_state_transition_intent",
    ...
    print("wave4_metric_current_state=PASS migration=030 current_projection=enabled durable_acceptance=enabled history_materialization=blocked poll_stream=independent")
